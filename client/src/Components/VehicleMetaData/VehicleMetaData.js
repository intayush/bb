        ...
        <Grid container component="div" direction="row">
            <Grid item xs={12} md={12} sm={12} lg={12} className="vehicleSummarySec">
                <div className="vehicleSummary">
                    {matches?<h3>More details about the Two-wheeler</h3>:<p style={{fontSize:'11px',fontWeight:'bold'}}>More details about the Two-wheeler</p>}
            ...
            <Grid item xs={12} md={12} sm={12} lg={12} className="vehicleReportSec">
                <div className="vehicleReport center-align">
                    {matches?<h2>Inspection Report</h2>:<p style={{fontSize:'12px',fontWeight:'bold'}}>Inspection Report</p>}
                    {matches?<><div><img src={blackHeadingLines} alt=""/></div><br/></>:<img src={mobiledivider}/>}
