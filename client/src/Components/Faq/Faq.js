          ...
          <Paper  elevation={3} className={classes.paper}>
            ...
            >
              ...
              <ExpansionPanelDetails >
                <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  <p style={{ fontSize: "10px" }}>
                    Step 3: You will be shown multiple options to select from
                    for the two-wheeler you want to buy, select any of them to
                    see further.
                  </p>
                </div>
              </ExpansionPanelDetails>
            ...
            <ExpansionPanel className={classes.collapsible}>
              ...
              <ExpansionPanelDetails style={{ fontSize: "10px" }}>
                After selecting the two-wheeler category, you can use the “Sort
                By” option to see the two-wheelers nearest to your location.
                <br />
                <br />
                Another way to see two-wheeler nearest to your location is by
                using the “Locate Store” feature, through which you can find out
                the BikeBazaar store nearest to your location.
              </ExpansionPanelDetails>
            </ExpansionPanel>
            ...
            >
              <ExpansionPanelSummary
                ...
                className={classes.faqQuestion}
              >
                I liked one of the listed Bike and want to see it, what should I
                do next?
              </ExpansionPanelSummary>
              <ExpansionPanelDetails style={{ fontSize: "10px" }}>
                ...
                <br />
                <br />
                You can visit the store and have a look at the bike and inspect
                it on all the parameters crucial for you.
              </ExpansionPanelDetails>
            </ExpansionPanel>
            <ExpansionPanel className={classes.collapsible}>
              <ExpansionPanelSummary
              ...
              <ExpansionPanelDetails style={{ fontSize: "10px" }}>
                ...
                <br />
                <br />
                Then it goes through a thorough refurbishment process and all
                the issues are resolved.
                <br />
                <br />
                So, when a bike is displayed for sale through BikeBazaar store,
                it’s free of any issues and you can be assured of its quality.
                <br />
                <br />
                All the vehicles are also covered with "Buyer protection" (Any
                unforeseen issue in a week’s time is resolved for Free) and
                "Free 6 Months' Warranty" (warranty on Engine & Transmission,
            ...
            >
              ...
              >
                ...
                stopping me from purchasing the bike right now. Can you help me
                with this?
              </ExpansionPanelSummary>
              <ExpansionPanelDetails style={{ fontSize: "10px" }}>
                ...
                <br />
                <br />
                BikeBazaar provides financial assistance to you through which
                you can purchase your dream bike at EMI starting at as low as
                ₹2000*.
              </ExpansionPanelDetails>
            </ExpansionPanel>
            <ExpansionPanel className={classes.collapsible}>
              ...
              <ExpansionPanelDetails style={{ fontSize: "10px" }}>
                If you want to avail the facility of low-cost EMI for the dream
                bike you want to purchase then you just need to show the
                interest in taking the loan by clicking on the checkbox
                “Interested in taking a loan”, while sharing your details.
                <br />
                <br />
                Our team will help you in taking the loan with low-cost EMI even
                if you don’t purchase the bike from the BikeBazaar store and buy
            ...
            <ExpansionPanel className={classes.collapsible}>
              ...
              <ExpansionPanelDetails style={{ fontSize: "10px" }}>
                Hassle-free document transfer is one of the biggest advantages
                of buying the used two-wheeler form BikeBazaar store.
                <br />
                <br />
