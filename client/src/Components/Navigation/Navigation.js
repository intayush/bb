          ...
          <ButtonGroup  fullWidth={true}  variant="contained" color="default">
            ...
            <Dialog  fullScreen open={filter_btn} onClose={()=>showfilter(false)}>
              ...
              <div style={{display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                <div className="action-btn" onClick={()=>showfilter(false)}><span style={{fontWeight:'bold',fontSize:'16px'}}>Cancel</span></div>
                <div className="red-action-btn" id="cancel-action"><span style={{fontWeight:'bold',fontSize:'16px',color:'white'}}>Apply</span></div>
              </div>
          </Dialog>
        </div>
      )}
